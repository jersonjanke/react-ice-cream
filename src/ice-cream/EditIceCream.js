...
import { validateDescription, validateQuantity, validatePrice } from '../utils/validator'
...
const EditIceCream = ({ match, history }) => {
    ...
    const quantityError = useValidation(menuItem.quantity, validateQuantity);
